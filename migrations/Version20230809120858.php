 ...
 */
final class Version20230809120858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE garages (id INT AUTO_INCREMENT NOT NULL, schedules_id INT NOT NULL, name VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, phone VARCHAR(10) NOT NULL, address VARCHAR(255) NOT NULL, INDEX IDX_8C4330E2116C90BC (schedules_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE images (id INT AUTO_INCREMENT NOT NULL, service_id INT NOT NULL, ad_id INT NOT NULL, path VARCHAR(255) NOT NULL, INDEX IDX_E01FBE6AED5CA9E6 (service_id), INDEX IDX_E01FBE6A4F34D596 (ad_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE schedules (id INT AUTO_INCREMENT NOT NULL, opened_days VARCHAR(30) NOT NULL, hours_am VARCHAR(60) NOT NULL, hours_pm VARCHAR(60) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE testimonials (id INT AUTO_INCREMENT NOT NULL, garage_id INT NOT NULL, author VARCHAR(60) NOT NULL, message LONGTEXT NOT NULL, note INT NOT NULL, validated TINYINT(1) NOT NULL, INDEX IDX_38311579C4FFF555 (garage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE garages ADD CONSTRAINT FK_8C4330E2116C90BC FOREIGN KEY (schedules_id) REFERENCES schedules (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE garages DROP FOREIGN KEY FK_8C4330E2116C90BC');
